...
macro(BEGIN_TESTCASES)
  ...
  target_link_libraries(gtest_dune_stuff pthread)
    ...
    target_link_libraries( test_${testname} ${ARGN} ${COMMON_LIBS} ${GRID_LIBS} gtest_dune_stuff boost_python ${PYTHON_LIBRARIES} ${Boost_LIBRARIES} )
    ...
    target_compile_options(test_${testname} PUBLIC -ftemplate-depth=1000 -I /usr/include/python2.7/ -lboost_python -lboost_system)
